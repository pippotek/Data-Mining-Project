...
DB_NAME = "mind_news"
BEHAVIORS_COLLECTION = "behaviors"
...
def load_tsv_to_mongo(db, collection_name, tsv_file, headers):
    ...
    if records:
        ...
        print(f"No records found in {tsv_file}.")
...
def main():
    ...
    # Paths to behaviors.tsv and news.tsv
    behaviors_tsv = os.path.join(train_dir, "behaviors.tsv")
    ...
    load_tsv_to_mongo(db, BEHAVIORS_COLLECTION, behaviors_tsv, BEHAVIORS_HEADERS)
    load_tsv_to_mongo(db, NEWS_COLLECTION, news_tsv, NEWS_HEADERS)
